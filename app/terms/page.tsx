...
import { FileText, Calendar, CheckCircle, Shield } from 'lucide-react';
...
function TermsContent() {
    ...
    if (!data) return <div className="p-10 text-center text-red-500">Failed to load terms.</div>;
            ...
            <div className="container mx-auto px-4 lg:px-8 py-20 relative z-10 max-w-4xl">
                ...
                <div className="mb-16 text-center space-y-6">
                    ...
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-500 font-mono bg-[#112240]/50 inline-block px-4 py-2 rounded-full border border-gray-800 mx-auto">
                        ...
                        Last Updated: <span className="text-gray-300">{new Date(data.lastUpdated).toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</span>
                    </div>
                ...
                <div className="mt-16 text-center p-8 rounded-3xl bg-gradient-to-br from-[#112240] to-transparent border border-gray-800/50">
                    ...
                    <h3 className="text-white font-bold mb-2">Transparency First</h3>
                    <p className="text-sm text-gray-500 max-w-md mx-auto">
                        We believe in open communication. If you have any questions about these terms, please contact our support team.
                    </p>
                </div>
            </div>
        </div>
